...
const NicknamePrompt = ({
	history,
	saveNicknameToStore: saveNicknameToStoreProps
}) => {
		...
		<div className='container'>
			...
			<div className='input-container'>
				<ul>
					...
					{error && (
						<div className='nicknameprompt-error'>
							Nickname must be between 6 and 15 characters long!
						</div>
					)}
				</ul>
			</div>
			<img
				src={nicknamePageWave}
				alt='nickname-page-wave'
				className='nickname-page-wave'></img>
		</div>
	);
};
...
export default connect(null, { saveNicknameToStore })(NicknamePrompt);
